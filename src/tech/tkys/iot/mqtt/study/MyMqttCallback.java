...
/**
 * Provides callback methods for MQTT subscriber clients.
 */
public class MyMqttCallback implements MqttCallback {
     ...
     *
     * If an application needs to persist data,
     * then it should ensure the data is persisted prior to returning from this method,
     ...
     * (for example, a response to this message), but the implementation must not disconnect the client,
